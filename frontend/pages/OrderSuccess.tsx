...
const OrderSuccess: React.FC = () => {
    ...
    useEffect(() => {
        // Aggressive clear: clear immediately when landing on success page
        console.log('OrderSuccess: Component mounted, clearing cart immediately...');
        clearCart();
            ...
            if (sessionId) {
                try {
                    ...
                    if (res.data.paymentStatus === 'paid') {
                        console.log('OrderSuccess: Payment verified successfully.');
                ...
                console.log('OrderSuccess: No session ID found in URL.');
                setPaymentVerified(true);
            }
            setLoading(false);
        };
    ...
    return (
        <div className="min-h-[60vh] flex items-center justify-center px-4 bg-orange-50/30">
            <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-2xl w-full max-w-md border border-green-50 text-center">
                ...
                <h1 className="text-4xl font-heritage font-bold text-orange-950 mb-4">Paiement Confirmé !</h1>
